  ...
  return (
    <div className="w-48 h-screen bg-white text-black flex flex-col fixed top-0 left-0 shadow-[4px_0_6px_-1px_rgba(0,0,0,0.1)]">
      ...
      <div className="p-6 border-b border-gray-600">
        <img src="https://drive.google.com/file/d/1wOk-fOYpT-U-sIZOWTm28qT8S-o7vtoh/view?usp=drive_link" alt="Logo" className="w-full max-w-28 ml-2 top-0 h-auto object-contain" />
      </div>
